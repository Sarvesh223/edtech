...
let UserController = class UserController {
    ...
    async addToCart(id, addToCartDto) {
    ...
    async removeFromCart(id, removeFromCartDto) {
        const user = await this.userService.removeFromCart(id, removeFromCartDto.courseId);
        return {
    ...
    async addToPurchasedCourses(id, addToCartDto) {
    ...
    async removeFromPurchasedCourses(id, removeFromCartDto) {
...
__decorate([
    (0, common_1.Post)(':id/cart/add'),
    (0, swagger_1.ApiOperation)({ summary: 'Add course to user cart' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Course already in cart' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_dto_1.AddToCartDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "addToCart", null);
__decorate([
    (0, common_1.Delete)(':id/cart/remove'),
    (0, swagger_1.ApiOperation)({ summary: 'Remove course from user cart' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Course not in cart' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_dto_1.RemoveFromCartDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "removeFromCart", null);
__decorate([
    (0, common_1.Get)(':id/cart'),
    (0, swagger_1.ApiOperation)({ summary: 'Get user cart with course details' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
__decorate([
    (0, common_1.Delete)(':id/cart/clear'),
...
__decorate([
    (0, common_1.Patch)(':id/cart/update'),
    (0, swagger_1.ApiOperation)({ summary: 'Update entire cart with course IDs' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_dto_1.UpdateCartDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateCart", null);
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    (0, common_1.Post)(':id/purchased-courses/add'),
    (0, swagger_1.ApiOperation)({ summary: 'Add course to user purchased courses' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Course already purchased' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_dto_1.AddToCartDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "addToPurchasedCourses", null);
__decorate([
    (0, common_1.Delete)(':id/purchased-courses/remove'),
    (0, swagger_1.ApiOperation)({ summary: 'Remove course from user purchased courses' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Course not found in purchased courses' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_dto_1.RemoveFromCartDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "removeFromPurchasedCourses", null);
